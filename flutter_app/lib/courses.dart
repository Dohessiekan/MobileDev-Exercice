...
class _CoursesState extends State<Courses> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          Color(0xFF303384), // Set the background color of the entire page
      body: Stack(
        children: [
          ListView(
            children: [
              ...
              Container(
                color:
                    Color(0xFF303384), // Background color for the top section
                ...
                child: Padding(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment
                        .end, // Align text to the bottom of the section
                    crossAxisAlignment: CrossAxisAlignment
                        .start, // Align text to the start (left) of the section
                    children: [
                      Text(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    SizedBox(
                        height:
                            25), // Add space between the top section and the search bar
                    // Search bar for finding courses
                    Container(
                      width: double
                          .infinity, // Make the search bar as wide as the screen
                      height: 55, // Height of the search bar
                      padding: EdgeInsets.symmetric(
                          horizontal:
                              15), // Horizontal padding inside the search bar
                      margin: EdgeInsets.symmetric(
                          horizontal:
                              15), // Horizontal margin outside the search bar
                          ...
                          Expanded(
                            child: TextField(
                              decoration: InputDecoration(
                                ...
                                hintStyle: TextStyle(
                                    color: Color(
                                        0xFFD4D4D4)), // Placeholder text color
                              ),
                            ),
                          ),
                        ],
                    ...
                    SizedBox(
                        height:
                            25), // Add space between the search bar and the categories section
                    // Categories section
                    Container(
                      width: double
                          .infinity, // Make the container as wide as the screen
                      decoration: BoxDecoration(
                        color: Colors
                            .white, // Background color for the categories section
                        borderRadius: BorderRadius.only(
                          topLeft:
                              Radius.circular(35), // Top left corner rounded
                          topRight:
                              Radius.circular(35), // Top right corner rounded
                        ),
                      ),
                      child: Column(
                        children: [
                          ...
                          Center(
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors
                                    .blue, // Color of the category indicator
                                borderRadius: BorderRadius.circular(
                                    5), // Rounded corners for the indicator
                              ),
                            ),
                          ),
                          SizedBox(
                              height:
                                  15), // Space between the indicator and the categories text
                          Padding(
                            padding:
                                const EdgeInsets.symmetric(horizontal: 20.0),
                            child: SingleChildScrollView(
                              scrollDirection: Axis
                                  .horizontal, // Horizontal scroll for categories
                              child: Row(
                                children: [
                                  CategoryItem(
                                    category: 'History',
                                  ...
                                  SizedBox(
                                      width:
                                          20), // Space between category texts
                                  CategoryItem(
                                    category: 'Science',
                          ...
                          SizedBox(
                              height:
                                  25), // Space between the categories and the course cards
                          Padding(
                            padding:
                                  ...
                                  children: courses.map((doc) {
                                    ...
                                    return Padding(
                                      ...
                                      child: CourseCard(
                                        ...
                                        image: data['image'],
                                        rating: data[
                                            'rating'], // Fetch the rating from Firestore
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => Detailcourse(
                                                  courseId: doc
                                                      .id), // Navigate to the Detailcourse page
                                            ),
                                          );
                                        },
                                      ),
                          ...
                          SizedBox(
                              height: 25), // Space to avoid content overflow
                          Align(
                            alignment: Alignment
                                .centerLeft, // Align 'Continue Course' text to the left
                            child: Padding(
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 15.0),
                              child: Text(
                          ...
                          SizedBox(
                              height:
                                  15), // Space between section title and the course cards
                          StreamBuilder<DocumentSnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final enrolledCourses =
                                  user['enrolledCourses'] as List<dynamic>? ??
                                      [];
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: isSelected
                  ? FontWeight.bold
                  : FontWeight.normal, // Change font weight based on selection
            ),
          ),
          if (isSelected)
            Container(
              margin:
                  EdgeInsets.only(top: 5), // Margin between text and underline
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Icon(Icons.schedule,
                          color: Colors.blue,
                          size: 14), // Blue icon next to hours
                      SizedBox(width: 5),
                      Text(
                        hours,
                        style: TextStyle(
