...
class CustomBottomNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: 70,
      color: Colors.deepPurple, // Background color for the bottom navigation bar
      child: BottomNavigationBar(
        backgroundColor: Colors.deepPurple, // Background color for the bottom navigation bar items
        selectedItemColor: Color.fromARGB(255, 3, 29, 145), // Selected item color
